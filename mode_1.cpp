...
void Mode_1::gameOver()
{
    ...
    // 弹窗关闭后，执行这里：
    emit gameFinished(); // 通知 MainWindow 切回菜单
}
...
{
    // 1. 暂停游戏逻辑
    bool wasRunning = m_gameTimer->isActive(); // 记录一下当前状态
    m_gameTimer->stop(); // 暂停倒计时
